...
def abrir_algebra():
    ...
    tk.Label(ventana_algebra, text="Matriz (usa formato Python, e.g. [[1,2],[3,4]])").pack(pady=5)
    matrix_entry = tk.Entry(ventana_algebra)
    matrix_entry.pack(pady=5)

    tk.Label(ventana_algebra, text="Constantes (para Cramer)").pack(pady=5)
    constants_entry = tk.Entry(ventana_algebra)
    constants_entry.pack(pady=5)

    tk.Label(ventana_algebra, text="Segunda matriz (para multiplicación)").pack(pady=5)
    matrix2_entry = tk.Entry(ventana_algebra)
    matrix2_entry.pack(pady=5)

    method_var = tk.StringVar(ventana_algebra)
    method_var.set("Gauss-Jordan")

    tk.Label(ventana_algebra, text="Método").pack(pady=5)
    method_menu = tk.OptionMenu(ventana_algebra, method_var, "Gauss-Jordan", "Regla de Cramer", "Multiplicación", "Inversa")
    method_menu.pack(pady=5)

    execute_button = tk.Button(ventana_algebra, text="Calcular", command=perform_operation)
...
def abrir_algoritmos():
    ...
    # Aquí puedes agregar más funcionalidades específicas de algoritmos
...
def abrir_matematica_discreta():
    ...
    # Botón de calcular
    tk.Button(frame, text="Calcular", command=calcular, bg="#4CAF50", fg="white").grid(row=4, column=1, pady=20)
...
def abrir_matematica_discreta():
    ...
    # Botón de calcular
    tk.Button(frame, text="Calcular", command=calcular, bg="#4CAF50", fg="white").grid(row=4, columnspan=3, pady=20)
